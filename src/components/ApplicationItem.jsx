    ...
    <div className="w-full px-[32px] py-[16px] flex items-center gap-[16px]">
      ...
      <div className="flex w-full flex-col gap-[8px]">
        <div className="flex items-center gap-[12px]">
          ...
          <span className={`py-[4px] px-[12px] whitespace-nowrap font-[400] text-[12px] rounded-[22px] ${complianceData.status ==='pending-review' ? 'text-[#FFA500] bg-[#ffa6002f]' : complianceData.status === 'rejected' ? 'text-[#FF3D00] bg-[#ff3c0034]' : 'text-[#26A54D] bg-[#26a54c34]'}`}>
        ...
        {complianceData.status ==='pending-review' && 'Your application has been successfully submitted and is currently being reviewed. You will be notified as once complete and you can proceed to the nest stage.'}
