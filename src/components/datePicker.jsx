...
const Datepicker = ({
  ...
  const calendar =
    "https://res.cloudinary.com/dzquobiiy/image/upload/v1723102505/calendar-2_gfztyv.svg";
      ...
      <div className="relative">
        <div className="flex flex-col gap-[6px] w-full">
          <div className="flex justify-between items-center border border-[#26A54D4F] rounded-[8px] px-[12px] h-[48px] w-full">
            <span className="border-none w-full text-[#3D454E] text-[14px] font-[400] ">
              {formatted}
            </span>
            <span className="bg-[#fff] flex items-center absolute right-[12px] h-[40px] w-[30px]">
              <FaRegCalendarAlt className="text-slate-400 text-[20px]" />
            </span>
          </div>
